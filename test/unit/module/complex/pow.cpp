...
//  std::cout << z_t{a0,a1} << "    " <<  z_t{a2,a3} << std::endl;
  TTS_ULP_EQUAL( eve::pow(z_t{a0,a1}, z_t{a2,a3}), eve::exp(eve::mul(eve::log(z_t{a0,a1}), z_t{a2,a3}) ), 2.0e5);
};
