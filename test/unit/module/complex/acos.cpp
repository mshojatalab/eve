  ...
  <typename T>(T const& a0, T const& a1 )
{
  ...
  for(auto e : a0)
  {
    for(auto f : a1)
    {
      TTS_ULP_EQUAL(eve::acos(eve::complex<e_t>(e, f)),  z_t(std::acos(c_t(e, f))), 2);
    }
  }
};
  ...
  <typename T>(T const& a0, T const&  a1)
{
  ...
  auto init_with_std = [std_acos](auto a0,  auto a1){
    ...
    {
      ce_t z(std_acos(a0.get(i), a1.get(i)));
      b.set(i, z);
    }
    return b;
  };
  ...
  <typename T>(eve::as<T>)
{
 ...
 TTS_ULP_EQUAL(eve::acos(c_t(eve::nan  (as<T>()), eve::one(as<T>()))),  c_t(std::acos(s_t(eve::nan  (as<T>()), eve::one(as<T>())))),  1.0);
 TTS_ULP_EQUAL(eve::acos(c_t(eve::nan  (as<T>()), eve::inf(as<T>()))),  c_t(std::acos(s_t(eve::nan  (as<T>()), eve::inf(as<T>())))),  1.0);
 TTS_ULP_EQUAL(eve::acos(c_t(eve::nan  (as<T>()), eve::nan(as<T>()))),  c_t(std::acos(s_t(eve::nan  (as<T>()), eve::nan(as<T>())))),  1.0);
 TTS_ULP_EQUAL(eve::acos(c_t(eve::zero (as<T>()), eve::nan (as<T>()))), c_t(std::acos(s_t(eve::zero (as<T>()), eve::nan (as<T>())))), 1.0);
 TTS_ULP_EQUAL(eve::acos(c_t(eve::one  (as<T>()), eve::nan (as<T>()))), c_t(std::acos(s_t(eve::one  (as<T>()), eve::nan (as<T>())))), 1.0);


 TTS_ULP_EQUAL(eve::acos(c_t(eve::one  (as<T>()), eve::inf (as<T>()))), c_t(std::acos(s_t(eve::one  (as<T>()), eve::inf (as<T>())))), 1.0);
 TTS_ULP_EQUAL(eve::acos(c_t(eve::inf  (as<T>()), eve::one (as<T>()))), c_t(std::acos(s_t(eve::inf  (as<T>()), eve::one (as<T>())))), 1.0);
 TTS_ULP_EQUAL(eve::acos(c_t(eve::inf  (as<T>()), eve::inf(as<T>()))),  c_t(std::acos(s_t(eve::inf  (as<T>()), eve::inf(as<T>())))),  1.0);
 TTS_ULP_EQUAL(eve::acos(c_t(-eve::nan  (as<T>()), eve::one(as<T>()))), c_t(std::acos(s_t(-eve::nan  (as<T>()), eve::one(as<T>())))),    1.0);
 TTS_ULP_EQUAL(eve::acos(c_t(-eve::nan  (as<T>()), eve::inf(as<T>()))), c_t(std::acos(s_t(-eve::nan  (as<T>()), eve::inf(as<T>())))),    1.0);
 TTS_ULP_EQUAL(eve::acos(c_t(-eve::nan  (as<T>()), eve::nan(as<T>()))), c_t(std::acos(s_t(-eve::nan  (as<T>()), eve::nan(as<T>())))),    1.0);
 TTS_ULP_EQUAL(eve::acos(c_t(-eve::one  (as<T>()), eve::inf (as<T>()))),c_t(std::acos(s_t(-eve::one  (as<T>()), eve::inf (as<T>())))),   1.0);
 ...
 TTS_ULP_EQUAL(eve::acos(c_t(0.5, -0.5)),  c_t(std::acos(s_t(0.5, -0.5))), 1.0);
 TTS_ULP_EQUAL(eve::acos(c_t(1, 1)),       c_t(std::acos(s_t(1, 1))), 1.0);
 TTS_ULP_EQUAL(eve::acos(c_t(1, 10)),      c_t(std::acos(s_t(1, 10))), 1.0);
 TTS_ULP_EQUAL(eve::acos(c_t(10, 10)),     c_t(std::acos(s_t(10, 10))), 1.0);
 TTS_ULP_EQUAL(eve::acos(c_t(10, 1)),      c_t(std::acos(s_t(10, 1))), 1.0);
};
