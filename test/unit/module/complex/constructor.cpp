...
<typename T>(eve::as<T>)
{
  ...
  eve::wide<eve::complex<T>>  z_v0{wo};
  ...
  TTS_EQUAL( eve::real(z_v0), wo     );
  TTS_EQUAL( eve::imag(z_v0), w_t{0} );
...
<typename T>(eve::as<T>)
{
  ...
  eve::wide<eve::complex<T>> z_l0(fill_r);
  ...
  TTS_EQUAL( eve::real(z_l0) , w_t(fill_r));
  TTS_EQUAL( eve::imag(z_l0) , w_t(0));
...
<typename T>(eve::as<T>)
{
  ...
  TTS_EQUAL ( eve::real(z_sc), eve::real(z_s) );
  TTS_EQUAL ( eve::imag(z_sc), eve::imag(z_s) );

  TTS_EQUAL ( eve::real(z_sa), eve::real(z_s) );
  TTS_EQUAL ( eve::imag(z_sa), eve::imag(z_s) );

  TTS_EQUAL ( eve::real(z_vc), eve::real(z_v) );
  TTS_EQUAL ( eve::imag(z_vc), eve::imag(z_v) );

  TTS_EQUAL ( eve::real(z_va), eve::real(z_v) );
  TTS_EQUAL ( eve::imag(z_va), eve::imag(z_v) );
};
