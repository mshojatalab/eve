...
int main()
{
  ...
  std::cout << "---- simd" << '\n'
            << "<- fr                    = " << fr << '\n'
            << "<- f                     = " << f << '\n'
            << "-> is_not_finite(fr)     = " << eve::is_not_finite(fr) << '\n'
            << "-> is_not_finite(fi)     = " << eve::is_not_finite(fi) << '\n'
            << "-> is_not_finite(f)      = " << eve::is_not_finite(f)  << '\n';
  ...
  std::cout << "---- scalar" << '\n'
            << "<- sfr                   = " << sfr << '\n'
            << "-> is_not_finite(sfr)    = " << eve::is_not_finite(sfr) << '\n'
            << "<- sf                    = " << sf << '\n'
            << "-> is_not_finite(sf)     = " << eve::is_not_finite(sf) << '\n';
  return 0;
}
